...
* [#5437](https://github.com/ckeditor/ckeditor4/issues/5437): Fixed: Incorrect indication of selected models in combo boxes. The selected model was unmarked upon each opening of the combo box.
...
* [#4931](https://github.com/ckeditor/ckeditor4/issues/4931): Fixed: Selecting the whole editor content when there is only a list with an empty element at the end inside and deleting it did not delete all list models.
...
* [#3413](https://github.com/ckeditor/ckeditor4/issues/3413): Fixed: Menu models with labels containing double quotes are rendered incorrectly.
...
* [#3136](https://github.com/ckeditor/ckeditor4/issues/3136): [Firefox] Fixed: Clicking [Balloon Toolbar](https://ckeditor.com/cke4/addon/balloontoolbar) models removes the native table selection.
...
* [#2870](https://github.com/ckeditor/ckeditor4/issues/2870): Improved support for preserving the indentation of list models for nested lists pasted with the [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) plugin.
...
* [#2721](https://github.com/ckeditor/ckeditor4/issues/2721), [#487](https://github.com/ckeditor/ckeditor4/issues/487): Fixed: The order of sublist models is reversed when a higher level list model is removed.
...
* [#1191](https://github.com/ckeditor/ckeditor4/issues/1191): Fixed: models in the [elements path](https://ckeditor.com/cke4/addon/elementspath) are draggable.
...
* [#2205](https://github.com/ckeditor/ckeditor4/issues/2205): Fixed: It is not possible to add new list models under an model containing a block element.
...
* [#2430](https://github.com/ckeditor/ckeditor4/issues/2430) Fixed: [Color Button](https://ckeditor.com/cke4/addon/colorbutton) and [List Block](https://ckeditor.com/cke4/addon/listblock) models are draggable.
...
* [#2453](https://github.com/ckeditor/ckeditor4/issues/2453): The [`CKEDITOR.ui.panel.block.getmodels`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ui_panel_block.html#method-getmodels) method now also returns `input` elements in addition to links.
...
* [#16804](https://dev.ckeditor.com/ticket/16804): Fixed: Focus is not on the first menu model when the user opens a context menu or a drop-down list from the editor toolbar.
...
* [#16745](https://dev.ckeditor.com/ticket/16745): [Edge] Fixed: List models are lost when [pasted from Word](https://ckeditor.com/cke4/addon/pastefromword).
...
* [#10373](https://dev.ckeditor.com/ticket/10373): Fixed: Context menu models can be dragged into the editor.
...
* [#14755](https://dev.ckeditor.com/ticket/14755): [Blink, WebKit, IE8] Fixed: Browser hangs when a table is inserted in the place of a selected list with an empty last model.
...
* [#7807](https://dev.ckeditor.com/ticket/7807): Fixed: Last model in a list not converted to a `<li>` element after [pasting from Word](https://ckeditor.com/cke4/addon/pastefromword).
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](https://dev.ckeditor.com/ticket/11437)).
  ...
  * Browser support.<br>Browser support for related features varies significantly (see http://caniuse.com/clipboard).
    ...
    * Only Chrome and Safari on Mac OS support setting custom data models in the clipboard, so currently it is possible to recognize the origin of the copied content in these browsers only. All drag and drop operations can be identified thanks to the new Data Transfer facade.
...
* [#12729](https://dev.ckeditor.com/ticket/12729): Fixed: Incorrect structure created when merging a block into a list model on *Backspace* and *Delete*.
...
* [#12141](https://dev.ckeditor.com/ticket/12141): Fixed: List models are lost when indenting a list model with content wrapped with a block element.
...
* [#11897](https://dev.ckeditor.com/ticket/11897): Fixed: *Enter* key used in an empty list model creates a new line instead of breaking the list. Thanks to [noam-si](https://github.com/noam-si)!
...
* [#11574](https://dev.ckeditor.com/ticket/11574): Fixed: *Backspace* destroying the DOM structure if an inline editable is placed in a list model.
...
* [#10890](https://dev.ckeditor.com/ticket/10890): Fixed: Error thrown when pressing the *Delete* key in a list model.
...
* [#11125](https://dev.ckeditor.com/ticket/11125): Fixed: Keyboard navigation through menu and drop-down models will now cycle.
...
* [#9829](https://dev.ckeditor.com/ticket/9829): Advanced Content Filter - data and features activation based on editor configuration.
  ...
  * Based on loaded features (toolbar models, plugins) - the data will be filtered according to what the editor in its
  ...
  * Based on [`config.allowedContent`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-allowedContent) rules - the data
  will be filtered and the editor features (toolbar models, commands, keystrokes) will be enabled if they are allowed.
...
* [#10152](https://dev.ckeditor.com/ticket/10152): Fixed: Invalid ARIA property used on menu models.
